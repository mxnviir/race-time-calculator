...
Works perfectly with our [OpenFOAM Auto-CFD](https://github.com/mxnviir/openfoam-for-stem) program. 
...
|--------|-------------|---------------|
| Drag force at 20 m/s (N) | Measured or estimated drag force on your car at a reference speed of 20 m/s Shameless plug, go use [this.](https://github.com/mxnviir/openfoam-for-stem)| 0.15 - 0.25 N |
